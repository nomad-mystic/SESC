<?php
/**
 * Template Name: custom-post-deaf-blindness
 *
...
<?php
	woo_loop_before();
		...
		$args = array (
			...
			'category_name'          => 'deaf-blindness-post',
			'order'                  => 'ASC',
			'orderby'                => 'title',
			'posts_per_page'         =>  '-1'
		);
...
?>
            ...
            <?php woo_main_after(); ?>
	    <?php if ( is_active_sidebar( 'deaf_blindness_right_widget' ) ) : ?>
			<aside id="sidebar">
				<?php dynamic_sidebar( 'deaf_blindness_right_widget' ); ?>
			</aside><!-- #primary-sidebar -->
		<?php endif; ?>

	</div><!-- /#main-sidebar-container -->
	<div id="removeClearBoth"></div>
