<?php
/**
 * Template Name: custom-post-other-health-impairments
 *
...
?>
 <!-- #content Starts -->
	...
	<?php if ( ( isset( $woo_options['woo_slider_biz'] ) && 'true' == $woo_options['woo_slider_biz'] ) && ( isset( $woo_options['woo_slider_biz_full'] ) && 'false' == $woo_options['woo_slider_biz_full'] ) ) { $saved = $wp_query; woo_slider_biz(); $wp_query = $saved; } ?>
            ...
            <section id="main"  class="resourcePostPage other-health-impairments-post-page">
...
<?php
	woo_loop_before();
		...
		$args = array (
			...
			'category_name'          => 'other-health-impairments-post',
			'order'                  => 'ASC',
			'orderby'                => 'title',
			'posts_per_page'         =>  '-1'
		);
