<?php
/**
 * Template Name: SESC Cadre Area File Cabinet Array Page
 *
...
?>
		...
		<?php if ( is_active_sidebar( 'cadre_area_page_nav' ) ) : ?>
			<aside id="cadreAreaNavAside" class="primary-sidebar widget-area leftColNav" role="complementary">
				<?php dynamic_sidebar( 'cadre_area_page_nav' ); ?>
